...
//   }
 ...
 //On my PC with standard 4000 by 3000 with 0.25 buffer the following transformation works
 //vec2 FragmentCoord = ((gl_FragCoord.xy)*1.466/(uSceneDims.zw))-(uSceneDims.xy/uSceneDims.zw);
 //That multiplier grows linearly with total pixel width using 4:3 aspet ratio.  Have not tested other aspecct ratios
 //Need to look into what that multiplier is and if it can be generated by variables that can be pulled from Foundry
